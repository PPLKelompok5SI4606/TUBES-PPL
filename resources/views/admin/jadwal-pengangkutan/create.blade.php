...
@section('content')
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="font-poppins font-medium text-gray-800 text-[28px] mb-6">Tambah Jadwal Pengangkutan</p>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                {{-- Body Form --}}
                <div class="p-6">
                    <form method="POST" action="{{ route('jadwal-pengangkutan.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <input id="nama_petugas" type="text" 
                                ...
                                name="nama_petugas" value="{{ old('nama_petugas') }}" required autofocus 
                        ...
                        <div class="mb-6">
                            ...
                            <input id="no_kontak" type="text" 
                                ...
                                name="no_kontak" value="{{ old('no_kontak') }}" required 
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="keterangan" rows="3"
                                ...
                                name="keterangan" placeholder="Tuliskan keterangan jika ada">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
